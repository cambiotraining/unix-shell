...
```bash
wget -O course_data.zip "https://www.dropbox.com/scl/fi/kgfq7pnt97weh45pogcxt/data-shell.zip?rlkey=gjz3pmb5ctku7q1fzwemfqbfl&st=6m0ct67p&dl=1"
```

```
--2022-10-18 14:13:22--  https://www.dropbox.com/scl/fi/kgfq7pnt97weh45pogcxt/data-shell.zip?rlkey=gjz3pmb5ctku7q1fzwemfqbfl&st=6m0ct67p&dl=1
...
```bash
curl -o course_data.zip -L "https://www.dropbox.com/scl/fi/kgfq7pnt97weh45pogcxt/data-shell.zip?rlkey=gjz3pmb5ctku7q1fzwemfqbfl&st=6m0ct67p&dl=1"
```
